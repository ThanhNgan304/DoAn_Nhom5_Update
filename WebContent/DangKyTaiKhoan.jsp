...
<body style="background: hsl(217, 12%, 84%)">
  ...
  <form style="width: 800px" action="KhachHang/Them" method="post">
  	<div>
  	<label >Họ tên</label>
    ...
    <div>
  	<label >Số CMND</label>
      <input type="text" class="form-control" id="inputDiachi" placeholder="Điền địa chỉ"  name="soCMND">
     ...
     <div class="form-group">
      ...
      <input type="text" class="form-control" id="inputSdt" placeholder="Điền số điện thoại"  name="soDT">
      ...
      <input type="text" class="form-control" id="inputTDN" placeholder="Điền tên đăng nhập"  name="tenDangNhap">
      <small  class="text-danger" id="validate-tendangnhap"></small><br>
    </div>

    <div class="form-group">
      <label for="pwd">Mật khẩu:</label>
      <input type="password" class="form-control" id="inputMK" placeholder="Điền mật khẩu" name="matKhau">

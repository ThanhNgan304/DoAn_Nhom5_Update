...
<!--===============================================================================================-->
 ...
 <script type="text/javascript"> 
	function validateForm() {
	    ...
	    if (tenDN == "") {
	        $("#validate-TenDN").html("Vui lòng nhập tên đăng nhập")
	    }
        if(email == ""){
    ...
    <div class="particle"></div>
		<div class="container-login100" style="background: hsl(200, 40%, 54%)">
			...
			<div class="wrap-login100">
				...
				<form action="DatLaiMKAdminServlet?tenAD=${tenAD }" method="Post" class="login100-form">
					<div class="wrap-input100 m-b-26" >
						<span class="label-input100">Tên đăng nhập</span>
						<input class="input100" type="text" value='${tenAD}' placeholder="Nhập tên đăng nhập" name="tenDangNhap" id="inputTenDN">
						<small class="text-danger" id="validate-TenDN" ></small><br>
					</div>

					<div class="wrap-input100  m-b-18" >
						<span class="label-input100">Mật khẩu mới</span>
						<input class="input100" type="password" placeholder="Nhập mật khẩu mới" name="matKhauMoi" id="inputMK">
					...
					<a href="TrangChuAdmin.jsp"><button type="button" class="login100-form-btn" >
						Hủy bỏ
					</button> </a>
				</form>
			</div>
